...
public abstract class SelectorProvider {
	private static java.nio.channels.spi.SelectorProvider instance = new SelectorProviderImpl();
	
	public static java.nio.channels.spi.SelectorProvider provider() { return instance; }
